...
BlockRegistry::BlockRegistry()
{
    ...
    Registry.emplace(BlockID::BARRIER, Block(BlockID::BARRIER, 4, 0, 0.f, BlockType::ABSTRACT, ItemID::NONE));
    Registry.emplace(BlockID::DIRT, Block(BlockID::DIRT, 1, 0, 40.f, BlockType::ORGANIC, ItemID::NONE));
    Registry.emplace(BlockID::GRASS, Block(BlockID::GRASS, 0, 0, 40.f, BlockType::ORGANIC, ItemID::NONE));
    Registry.emplace(BlockID::NONE, Block(BlockID::NONE, -1, -1, 0.f, BlockType::ABSTRACT, ItemID::NONE));
    Registry.emplace(BlockID::ORE, Block(BlockID::ORE, 3, 0, 120.f, BlockType::ORE, ItemID::BRONZE));
    Registry.emplace(BlockID::STONE, Block(BlockID::STONE, 2, 0, 100.f, BlockType::SOLID, ItemID::STONE));
}
